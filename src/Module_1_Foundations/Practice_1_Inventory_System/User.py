...
class User:
    ...
    def ask(cls) -> User:
        ...
        name: str = "-".join(input("Nombre: ").split(" "))
        ...
        while True:
            ...
            if id is None:
                print("Por favor, proporcione un ID de usuario válido.")
            else:
                break
        ...
        while True:
            phone_number = None
            with suppress(Exception):
                phone_number = int("".join(input("Número de teléfono: ").split(" ")))
            
            if phone_number is None:
                print()
                print("[yellow]Por favor, proporcione un número de teléfono válido.[/]")
            else:
                break
